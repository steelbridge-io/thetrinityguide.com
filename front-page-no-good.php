...
/*function minimum_front_page_enqueue_scripts() {
  ...
  $image1 =  "https://dev.thetrinityguide.com/video/ttg-driftboat.ogv";
  $image2 =  "https://dev.thetrinityguide.com/video/ttg-driftboat.mp4";
  $image3 =  "https://dev.thetrinityguide.com/video/ttg-driftboat.webm";
  $image4 =  "https://dev.thetrinityguide.com/video/ttg-driftboat-vid.webp";
	
	//* Load scripts only if custom backstretch image is being used
	if ( ! empty( $image1 || $image2 || $image3 || $image4 ) ) {
   ...
   // wp_localize_script( 'minimum-backstretch-set', 'BackStretchImg1', array( 'src' => $image1 ) );
    wp_localize_script( 'minimum-backstretch-set', 'BackStretchImg2', array( 'src' => $image2 ) );
   // wp_localize_script( 'minimum-backstretch-set', 'BackStretchImg3', array( 'src' => $image3 ) );
    wp_localize_script( 'minimum-backstretch-set', 'BackStretchImg4', array( 'src' => $image4 ) );
